...
def _format_html_report(
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 700px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #1a1a2e, #16213e); color: #fff; padding: 20px 25px; border-radius: 8px 8px 0 0;">
            <h2 style="margin: 0 0 5px 0;">🏀 NBA Fantasy Advisor</h2>
            <p style="margin: 0; color: #a0aec0; font-size: 14px;">Waiver Wire Report — {now}</p>
        </div>
        ...
        <p style="color:#999;font-size:12px;margin-top:20px;">
            Generated by <strong>NBA Fantasy Advisor</strong> (v2) — automated watch mode.
            <br>Adj_Score = Z × needs × availability × injury × schedule + recency + trending
        </p>
    </body>
    </html>
    """
...
def send_email_report(
    ...
    html_body = _format_html_report(rec_df, schedule_analysis, top_n)
